...
public class PartieGUI {
	...
	public void play(AccueilGUI accueil) {
        ...
        playButton.setFont(new Font("Eurostile", Font.PLAIN, 20));
		...
		//Bouton Se coucher
		jbSeCoucher.setFont(new Font("Eurostile", Font.PLAIN, 20));
	...
	public void initialize(AccueilGUI accueil) {
		...
		//Panel Tas
		jpTas.setBounds(582, 90, 658, 350);
		...
		jpOptions.setBorder(BorderFactory.createEmptyBorder(20,152,20,152));
	...
	public void vainqueur() {
		...
		iconWin = new ImageIcon("main/images/win.png");
		JLabel win = new JLabel(iconWin);
		JPanel jpWin = new JPanel();
		jpWin.add(win);
		jpWin.setBounds(665, 88, 400, 250);
	...
	public void perdant() {
		...
		iconLose = new ImageIcon("main/images/lose.png");
		JLabel lose = new JLabel(iconLose);
		JPanel jpLose = new JPanel();
		jpLose.add(lose);
		jpLose.setBounds(715, 110, 400, 250);
